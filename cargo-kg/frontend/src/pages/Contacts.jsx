      ...
      <main className="flex-grow py-12 px-4 max-w-7xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-2xl shadow border">
            ...
            <p className="mb-2"><strong>Адрес:</strong> г. Бишкек, ул. Киевская 100, офис 204</p>
            <p className="mb-2"><strong>Телефон:</strong> +996 555 123 456</p>
            <p className="mb-6"><strong>Режим работы:</strong> Пн-Сб: 09:00 - 18:00</p>
            
            <a href="https://wa.me/996555123456" className="block w-full text-center bg-green-500 text-white py-3 rounded-lg font-bold hover:bg-green-600 mb-3">
              Написать в WhatsApp
            </a>
